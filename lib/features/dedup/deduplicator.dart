...
class Deduplicator {
  ...
  Future<IngestOutcome> processIncoming({
    ...
    final fingerprint = parsed.isFailed
        ? TransactionParser.buildFailedFingerprint(
            occurredAt: occurredAt,
            merchant: parsed.merchant,
            rawText: rawText,
            referenceId: referenceId,
          )
        : TransactionParser.buildFingerprint(
    ...
    var needsReview = !parsed.isFailed &&
